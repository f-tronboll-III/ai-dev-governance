...
The four protocols above are the spine. As an enterprise grows, seven more disciplines become load-bearing — each one a deep-dive in its own right.
...
These seven layered disciplines connect into the spine the same way the others do: they ride on the four foundations, they accumulate evidence in changelogs, and they earn their place by surviving real failures. Adopt them when your shape demands them — not before.
...
- [Getting Started](getting-started.md) · [The Two Roles](two-roles.md) · [The Context Cascade](context-cascade.md) · [File Handling](file-handling.md) · [Checkpoints & Handoffs](checkpoints-handoffs.md) · [The Sanity Check](sanity-check.md) · [Bounded Deviation](bounded-deviation.md) · [Governance Sync](governance-sync.md) · [The Roadmap System](roadmap-system.md) · [The QA Gate](qa-gate.md) · [The Delta Log](delta-log.md) · [Durable Memory](durable-memory.md) · [Architecture Graphs](architecture-graphs.md) · [Autonomous Loops](autonomous-loops.md) · [Infrastructure Limits](infrastructure-limits.md) · [Secrets and Rotation](secrets-and-rotation.md) · [Dependency Management](dependency-management.md) · [Cost Management](cost-management.md)
